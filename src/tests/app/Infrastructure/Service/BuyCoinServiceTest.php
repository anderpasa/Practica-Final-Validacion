...
class BuyCoinServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->buyCoinService = new BuyCoinService($this->walletDataSourceMock, $this->cryptoCoinDataSourceMock);
    }
    ...
    public function testExecute(): void
    {
        ...
        $this->walletDataSourceMock->shouldReceive('insertCoin')
            ->once()
            ->with($wallet, $coin, $amount_usd);

        $response = $this->buyCoinService->execute($coin_id, $wallet_id, $amount_usd);
